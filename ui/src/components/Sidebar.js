            ...
            <div className={styles.main_content}>
                <div className={styles.creation_area}>
                    ...
                    <div className={styles.create_event}>
                        <button
                            onClick={() =>
                                createEventWithCurrentTime(getCurrentDay())
                            }>
                            Create An Event
                        </button>
                    </div>
                ...
                <div className={styles.copyright}>
                    <p>
                        Calendo is an event-driven, TypeScript application
                        demonstrating some of the core features of Google
                        Calendar.
                    </p>
                    <p>
                        Created by{" "}
                        <a href="https://benjaminkinga.com">Benjamin Kinga</a>
                    </p>
                    <p>
                        <a href="https://github.com/thescripted/calendo">
                            Source Code
                        </a>
                    </p>
                </div>
